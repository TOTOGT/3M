...
\textbf{Público-alvo:} pesquisadores em Matemática, pós-graduandos e professores universitários brasileiros que precisam publicar, apresentar e arbitrar trabalhos em língua inglesa.\quad
\textbf{Portal Bienal:} \url{https://grossi-ops.github.io/Atratores/}.
...
% =====================================================================
\section*{Exposição Local}

A apresentação tem extensão pública complementar na exposição digital \emph{Cajueiro: an exhibit on the Cashew Principle of Academic Writing}, hospedada em \url{https://grossi-ops.github.io/cajueiro/}. A exposição reúne os 14~prompts do programa, exemplos navegáveis das quatro estruturas (raiz profunda / raízes laterais / copa / propagação) e uma linha do tempo audiovisual da árvore de Pirangi como \emph{topos} pedagógico. O endereço será projetado durante a comunicação e listado no QR-code do pôster acompanhante (PO\_10).
